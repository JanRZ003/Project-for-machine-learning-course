...
def generate_folds(examples_path, output_path, dataset_name, folds = 5):
    ...
    for i in range(0, folds):
        ...
        config_file = open(output_path + "/" + dataset_name + "_fold_" + str(i + 1) + ".conf", "a")
...
def generate_datasets(malware_p, benign_p, total, dataset_count):
...
def write_pos_neg_examples(malware, benign, save_path, dataset_name):
    ...
    output_file = open(save_path + "/" + dataset_name + "_examples.json", "a")
...
def map_to_ontology(dataset, ot, save_path, dataset_name):
    ...
    raw_file = open(save_path + "/" + dataset_name + "_raw.json", "a")
